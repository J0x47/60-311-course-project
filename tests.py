...
from app import flask_bcrypt, db, login_manager
...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
            SQLALCHEMY_DATABASE_URI='mysql://forsuser:forsdb2018@localhost/fors_test'
        )
    ...
    def setUp(self):
        ...
        admin = User(username="admin", password="admin2018", is_admin=True, is_employee=True)

        # create test non-admin user
        user = User(username="test", password="test2018")
